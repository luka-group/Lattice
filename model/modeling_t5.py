...
class T5Attention(nn.Module):
    ...
    def compute_invariant_bias(self, query_length, key_length, type_ids, row_ids, col_ids):
...
class T5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        if not self.is_decoder and len(attention_mask.shape) == 2 and type_ids is not None:
            # may delete 'and type_ids is not None'
            attention_mask = rewrite_encoder_attention_mask(attention_mask, type_ids, row_ids, col_ids)
